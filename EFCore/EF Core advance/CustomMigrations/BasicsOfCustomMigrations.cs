...
public class BasicsOfCustomMigrations
{
    ...
    //1. We create a new migrations: "dotnet ef migrations add <migration name>"
    ...
    //Examples are presented in other .cs files in this folder
}