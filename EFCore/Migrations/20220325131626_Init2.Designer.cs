...
namespace EFCore.Migrations
{
    ...
    [Migration("20220325131626_Init2")]
    partial class Init2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore.Data_models.Salary", b =>
                {
                    ...
                    b.HasIndex("SalaryTransferId")
                        .IsUnique()
                        .HasFilter("[SalaryTransferId] IS NOT NULL");
            ...
            modelBuilder.Entity("EFCore.Data_models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCore.Data_models.Order", b =>
                {
                    ...
                    b.HasOne("EFCore.Data_models.Product", "Product")
                        .WithOne("Order")
                        .HasForeignKey("EFCore.Data_models.Order", "ProductId")
            ...
            modelBuilder.Entity("EFCore.Data_models.Salary", b =>
                {
                    b.HasOne("EFCore.Data_models.SalaryTransfer", "SalaryTransfer")
                        .WithOne("Salary")
                        .HasForeignKey("EFCore.Data_models.Salary", "SalaryTransferId");
            ...
            modelBuilder.Entity("EFCore.Data_models.Transaction", b =>
                {
                    ...
                    b.HasOne("EFCore.Data_models.Order", "Order")
                        .WithMany("Transactions")
