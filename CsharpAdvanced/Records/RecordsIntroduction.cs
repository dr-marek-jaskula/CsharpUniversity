...
public class Basics
{
    ...
    public void Work_With_Naive_Hero()
    {
        ...
        Console.WriteLine(Equals("Homelander", h.Name));

        // Class is mutable. Should it be?
        h.Name = "Stormfront";
        Console.WriteLine(Equals("Stormfront", h.Name));
    }
    #endregion
    ...
    public void Work_With_Ctor_Hero()
    {
        ...
        Console.WriteLine(Equals("DC", h1.Universe));
    ...
    public void Work_With_Deconstructable_Hero()
    {
        ...
        Console.WriteLine(Equals("Translucent", name));
        Console.WriteLine(canFly);
    }
    #endregion

    #region Magic programming with records
    ...
    public void Work_With_Hero()
    {
        ...
        Console.WriteLine(Equals("The Deep", name));
        Console.WriteLine(canFly);

        // Cloning with changes
        var h3 = h1 with { Name = "Stormfront" };
        Console.WriteLine(Equals("DC", h3.Universe));
        ...
        Console.WriteLine(Equals(h1, anotherH1));
